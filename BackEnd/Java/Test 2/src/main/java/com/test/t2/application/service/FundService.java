...
import com.test.t2.infrastructure.adapter.out.UserFundInvestmentRepository;
...
public class FundService {
    ...
    private void sendNotification(User user, String subject, String message) {
        if (PreferredNotificationType.EMAIL.equals(user.getPreferredNotification())) {
            ...
            logger.warn("La notificación no puede ser enviada: No se especificó un medio de notificación válido.");
        }
    }
